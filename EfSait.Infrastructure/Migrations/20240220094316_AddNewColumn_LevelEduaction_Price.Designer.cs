...
namespace EfSait.Infrastructure.Migrations
{
    ...
    [Migration("20240220094316_AddNewColumn_LevelEduaction_Price")]
    partial class AddNewColumn_LevelEduaction_Price
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EfSait.Entity.EducationDirection.Direction", b =>
                {
                    ...
                    b.Property<Guid>("GeneralDirectionId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("EfSait.Entity.EducationDirection.GeneralDirection", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ProfileYearRecruitment", b =>
                {
                    ...
                    b.HasKey("ProfilesId", "YearRecruitmentsId");
            ...
            modelBuilder.Entity("EfSait.Entity.EducationDirection.Direction", b =>
                {
                    b.HasOne("EfSait.Entity.EducationDirection.GeneralDirection", "GeneralDirection")
                        .WithMany("Directions")
                        .HasForeignKey("GeneralDirectionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("GeneralDirection");
                });
            ...
            modelBuilder.Entity("EfSait.Entity.EducationDirection.Profile", b =>
                {
                    ...
                    b.HasOne("EfSait.Entity.EmploeeDivision.Division", null)
                        .WithMany("Profiles")
                        .HasForeignKey("DivisionId");
